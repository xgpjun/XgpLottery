...
public class ReceiveUtils {
    ...
    public static void createLottery(Player player) {
        ...
        XgpLottery.foliaLibAPI.getScheduler(player, null).runTask(() -> {
            try {
                ...
                try {
                    ...
                    player.sendMessage(ChatColor.RED + LangUtils.TimeOut);
                        ...
                        XgpLottery.foliaLibAPI.getScheduler(player, null).runTask(() -> player.openInventory(inventory));
    ...
    public static void receiveWeight(Player player, Award award, PoolGui returnGui) {
        player.closeInventory();
        XgpLottery.foliaLibAPI.getScheduler(player, null).runTaskAsynchronously(() -> {
            try {
